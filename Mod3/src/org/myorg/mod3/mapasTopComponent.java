 ...
 */
@ConvertAsProperties(
        dtd = "-//org.myorg.mod3//mapas//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "mapasTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "editor", openAtStartup = true)
@ActionID(category = "Window", id = "org.myorg.mod3.mapasTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_mapasAction",
        preferredID = "mapasTopComponent"
)
@Messages({
    "CTL_mapasAction=mapas",
    "CTL_mapasTopComponent=mapas Window",
    "HINT_mapasTopComponent=This is a mapas window"
})
public final class mapasTopComponent extends TopComponent implements JMapViewerEventListener {
    ...
    public mapasTopComponent() {
    //    super("JMapViewer Demo");
        setSize(400, 400);

        treeMap = new JMapViewerTree("Zones");
        initComponents();
        setName(Bundle.CTL_mapasTopComponent());
        setToolTipText(Bundle.HINT_mapasTopComponent());
   ...
   //     map().addMapMarker(new MapMarkerCircle(germanyWestLayer, "North of Suisse", new Coordinate(48, 7), .5));
    ...
    //    map().addMapMarker(new MapMarkerCircle(spain, "La Garena", new Coordinate(40.4838, -3.39), .002));
        ...
        map().addMapMarker(new MapMarkerDot(spain, "Valencia", 39.5, -0.5));
